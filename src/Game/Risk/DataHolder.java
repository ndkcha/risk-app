...
public class DataHolder implements Serializable {
    ...
    /**
     * changes the phases in each turn. and it automatically changes the player
     * turn
     */
    ...
    /**
     * Update the active player object. It's used in order to update the
     * conquered countries and its armeis.
     *
    ...
    /**
     * Has everyone reached the max limit? It's supposed end the game if true
     *
