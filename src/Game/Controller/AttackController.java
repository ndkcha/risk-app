...
public class AttackController {
	...
	public int attack(String attackingCountry, String defendingCountry,
		...
		if (mode == 0) {
			...
			while (!attackResult) {
				if (modeCounter < 10) {
					...
					if (!attackResult) {
						...
						// sttack if true
						Iterator itForCountriesConquered = countriesConquered
			...
			if (attackResult) {
				...
				// moveArmies(selectedNoOfArmies, player, attackingCountry,
				// defendingCountry);
	 ...
	 *            the attacking country name
	 * @param defendingCountry
	 *            the country on which attack is done
	 * @param chosenNoOfDice
	 *            number of dice used by attacker
	...
	public boolean attackBetweenTwoCoutries(String attackingCountry,
		...
		for (int i = 0; i < allPlayersList.size(); i++) {
			...
			if (countriesConqueredTmp.containsKey(defendingCountry)) {
				Iterator itForCountriess = countriesConqueredTmp.entrySet()
	 ...
	 *
	 * @param defendingCountry
	 *            the country on which attack is taking place
	 */
