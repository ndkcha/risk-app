...
public class AttackController {
    ...
    public int attack (String attackingCountry,String defendingCountry,int mode,int numberOfDice) {
        ...
        if (mode == 0) {
            ...
            if (attackResult) {
                ...
                for (int i = 0; i < allPlayersList.size(); i++) {
                    ...
                    Iterator itForCountriesConquered = countriesConqueredTmp
                        .entrySet().iterator();// iterator for countries conqureeed by player
                    while (itForCountriesConquered.hasNext()) {
            ...
            if (attackResult) {
                ...
                //set armies in the drop down box to select from get the selected armies
    ...
    public boolean attackBetweenTwoCoutries (String attackingCountry,String defendingCountry,int chosenNoOfDice) {
        ...
        for (int i = 0; i < diceRollValuesOfAttacker.length; i++) {
    ...
    /**
     * Gives a random value of the dice. nextInt(max - min)
     *
